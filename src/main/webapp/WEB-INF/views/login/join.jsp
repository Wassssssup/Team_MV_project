...
<%@page import="kr.co.ezenac.DAO.MemberDAO"%>
<%@page import="kr.co.ezenac.VO.InsertMemberVO"%>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <title></title>
 <!-- 부트스트랩 -->
    <link href="http://localhost/Team_MV_project/common/bootstrap-3.3.2/css/bootstrap.min.css" rel="stylesheet">
    <!--  jQuery CDN(contents Delivery Network) -->
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
	<!--  bootstrap  -->
 	<script src="http://localhost/Team_MV_project/common/bootstrap-3.3.2/js/bootstrap.min.js"></script>
...
<body>
		...
		<%@ include file="../header.jsp" %>
		 <form action="join.jsp" name = "frm" method = "post" id="frm">
		<div id ="main">
				<h3>
