...
import kr.co.ezenac.VO.InsertMemberVO;
import kr.co.ezenac.VO.MemberIdFindVO;
import kr.co.ezenac.VO.MemberLoginVO;
import kr.co.ezenac.VO.MemberPassFindVO;
import kr.co.ezenac.VO.SelectUpdateMemberVO;
...
public class MemberDAO {
	...
	public int insertMember(InsertMemberVO imVO) throws SQLException{
		...
		try {
			...
			pstmt.setString(2, imVO.getMemPass());
